...
class ChildrenBooks extends Book {
    ...
    public ChildrenBooks(String title, String author, int year, String genre) {
        super(title, author, year);
        this.genre = genre;
    }
    ...
    @Override
    public void displayInfo() {
        System.out.println("Детская  книга: " + title);
        System.out.println("Автор: " + author);
        System.out.println("Год издания: " + year);
        System.out.println("Жанр: " + genre);
    }
...
public class Library2 {
    public static void main(String[] args) {
        Book[] books = {
            ...
            new ChildrenBooks("Волшебник Изумрудного города", "Александр Волков", 2023, "Сказочная серия")
        };
